	 ...
	 <div class="col-md-12 column">
			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					 <form class="form-inline" action="EditTiaozaoReleaseServlet?flag=edit" method="post" onsubmit="return validate_form(this);" enctype="multipart/form-data" >      
						 ...
						 &nbsp商品类别：<select name="goodssort" class="form-control" >
						 ...
						 &nbsp商品级别：<input type="text" name="class" class="form-control" id="class" onKeyUp=""><br>
						 &nbsp商品品牌：<input type="text" name="brand" class="form-control" id="brand" onKeyUp=""><br>
