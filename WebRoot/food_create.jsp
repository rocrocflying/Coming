...
<![endif]-->
    ...
    <div class="row">
    <form method="POST" action="FoodActivityServlet" enctype="multipart/form-data"  class="form-horizontal" id="create-activity-form">
        ...
        <div class="panel panel-success">
            ...
            <div class="panel-body">
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input id="title" type="text" value="" name="acttitle" class="form-control" placeholder="5-50字 " required>
                    </div>
                </div>
                <div class="form-group">
                    <label for="description" class="col-sm-3 control-label">活动描述<span class="text-danger"> *</span> :</label>
                    <div class="col-sm-9">
                        <textarea id="description" name="actdetail" class="form-control" rows="5" placeholder="10-2000字" required></textarea>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <label for="start-time" class="col-sm-3 control-label">开始时间<span class="text-danger"> *</span> :</label>
                     <div id="start-time-picker" class="input-group date col-md-8 col-sm-8" data-date="2015-04-26 13:25:43" data-date-format="yyyy MM dd日 - HH:ii p" data-link-field="start-time">
                ...
                <div class="form-group">
                  ...
                  <div id="end-time-picker" class="input-group date col-md-8 col-sm-8" data-date="2015-04-26 13:25:43" data-date-format="yyyy MM dd日 - HH:ii p" data-link-field="end-time">
                        <input class="form-control" size="16" type="text" value="" readonly>
                        <span class="input-group-addon"><span class="glyphicon glyphicon-remove"></span></span>
                        <span class="input-group-addon"><span class="glyphicon glyphicon-time"></span></span>
                    </div>
