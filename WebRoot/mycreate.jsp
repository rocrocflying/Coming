...
{
session.setAttribute("mycreate","MyCreateServlet");
   ...
   <div class="container" id="main"> 
     <div class="row" id="activity-container">
       <div class="col-xs-12 col-sm-6 col-md-4 activity-item">
          <span class="text-primary">  <h3>我创建的活动</h3></span>
            <hr/>
        </div>
        
        <c:forEach var="p" items="${myCreateActivity}">
         <div class="col-xs-12 col-sm-6 col-md-4 activity-item wrap" > 
            <div class="panel panel-success" style="height:465px;">  
                ...
                <p class="lead">${p.act_title}</p>  <p>
                       <span class="text-info text-info fa fa-user"></span> ${p.act_charge} 
                       <span class="text-primary  fa fa-bell-o"></span> ${nowtime<=p.end_date?"未结束":"已结束"} 
                        <span class="text-danger fa fa-heart-o"></span> ${p.act_count}人参加
                         ...
                         <span    class="text-danger fa fa-thumbs-o-up">${p.act_good} </span> 
                       
                         </p> <hr/> <p >
                      
                         <a class="pull-left btn btn-default" href=" DeleteActivityServlet?aid=${p.act_id}"><span class="text-danger glyphicon glyphicon-remove-sign"></span> 删除</a>
                       &nbsp &nbsp <a class="pull-center btn btn-default" href="ModifyActivityServlet?aid=${p.act_id}"><span class="text-danger glyphicon glyphicon-edit"></span> 修改</a>
                         <a class="pull-right btn btn-default"  href="ShowActivityViewServlet?aid=${p.act_id}" target="_blank">  查看详情  </a> </p> 
                          <hr/>
                          <span class="text-primary glyphicon glyphicon-time"></span> ${p.act_date}
                         </div> 
                      </div> 
            </div>
        </c:forEach>
