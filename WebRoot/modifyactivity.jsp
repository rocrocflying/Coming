...
<br/>
    ...
    <div class="row">
    <form method="POST" action="ActivityServlet?aid=${activity.act_id}" enctype="multipart/form-data"  class="form-horizontal" id="create-activity-form" onsubmit="return checkAll();">
        ...
        <div class="panel panel-success">
            ...
            <div class="panel-body">
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input id="title" type="text" value="${activity.act_title }" name="acttitle" class="form-control" placeholder="5-50字 ,如周末骑车去大理" >
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <input id="location" name="actplace" class="form-control" type="text" value="${activity.act_place}" placeholder="如大理、丽江" />
                    </div>
                </div>
                <div class="form-group">
                    <label for="cover" class="col-sm-3 control-label">封面图片<span class="text-danger">*</span>:</label>
                    <div class="col-sm-6">
                ...
                <div class="form-group">
                    ...
                    <div id="start-time-picker" class="input-group date col-md-8 col-sm-8" data-date="2015-04-15 17:29:29" data-date-format="yyyy-mm-dd HH:mm:ss" data-link-field="start-time">
                        <input id="strattime" class="form-control" name="begindate" size="16" type="text" value="${activity.begin_date}" readonly>
                ...
                <div class="form-group">
                    ...
                    <div id="end-time-picker" class="input-group date col-md-8 col-sm-8" data-date="2015-04-15 17:29:29" data-date-format="yyyy-mm-dd HH:mm:ss" data-link-field="end-time">
                        <input id="endtime" class="form-control" name="enddate" size="16" type="text" value="${activity.end_date}" readonly>
    ...
    <div class="col-sm-6 col-md-6">
        ...
        <div class="well">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <input id="name" type="text" value="${activity.act_charge}" name="actcharger" class="form-control" placeholder=""  >
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <input id="tel" type="tel" value="${activity.act_phone}"  name="actphone" class="form-control" placeholder="">
                </div>
            </div>
            <div class="form-group">
                <label for="email" class="col-sm-3 control-label">Email:</label>
                <div class="col-sm-5">
                    <input id="email" type="email" value="${activity.act_email}" name="actemail" class="form-control" placeholder="">
                </div>
            </div>
            <div class="form-group">
                <label for="qq" class="col-sm-3 control-label">QQ:</label>
                <div class="col-sm-5">
                    <input id="qq" type="text" value="${activity.act_qq}" name="actqq" class="form-control" placeholder="">
                </div>
            </div>
            <div class="form-group">
                <label for="wechat" class="col-sm-3 control-label">微信号:</label>
                <div class="col-sm-5">
                    <input id="wechat" type="text" value="${activity.act_weix}" name="actweix" class="form-control" placeholder="">
                </div>
            </div>
        </div>
        <input class="btn-block btn-danger btn-lg btn" id="btn-submit-create"  data-loading-text="提交中..."  type="submit" value="保存修改"/>
    </div>
...
function checkAll(){
	...
	if(checkTitle() && checkDescription() && checkLocation() && checkName() && checkTel()&& checkQq()){
		return true;
	}
	return false;
}
...
<script type="application/javascript">
  ...
  <script>
 function myfun() {document.getElementById("description").innerHTML=${activity.act_detail}; }
     window.onload=myfun;
 </script> 
