...
<html>
  ...
  <body style="background:#E0E0E0"> 
	...
	<%while(it.hasNext()){
  	UserOrderBean sgc=(UserOrderBean)it.next();
  	 %>
			...
			<center>
					<a href="UserTiaozaoOrderServlet?flag=detail_1&purchaseOrderId=<%=sgc.getPurchaseOrderId()%>">
					<img alt="" src="img/img_goods/dingdan.jpg"  width="100%"></a>
			</center>
				</div>
				<div class="panel-footer" style="height: 35">
				<img alt="" src="img/logo/price.png" width="20" height="20" align="right"> <p align="right"><%=sgc.getTotalprice() %></p>
				</div>
			</div>
		<% 
			}
