...
import meishi.ActivitySql_food;
import entity.activity_info;

public class Lovefood extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if(!uid.isEmpty())
		{
		    ActivitySql_food as=new ActivitySql_food();
		 	
			//Activity activity =new Activity();
			List<activity_info> activityList= as.querymaxProduct();
