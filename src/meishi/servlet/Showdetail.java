...
public class Showdetail extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		activity_info activity = ab.queryActivityBypId(id);
		request.setAttribute("food", activity);
		request.getRequestDispatcher("activityfood_detail.jsp").forward(request, response);
